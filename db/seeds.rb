...
puts "Creating items"
items = [
  { user: rodrigo, name: "Ping Pong Racket", description: "Large face for increased tolerance, an oval grip for comfort and an aluminum frame for stability, the TR100 is the ideal racquet for beginners.", price: 15, image_url: "items/pingpong.jpg", address: "Cologne Dom"},
  { user: amanda, name: "Baseball Kit", description: "Really nice baseball kit for beginners to intermediate players. Everything comes clean and well maintained. Enjoy your baseballing!", price: 150, image_url: "items/baseball.jpg", address: "Nippes, Cologne"},
  { user: rodrigo, name: "Mountain Bike", description: "This bikepacking beast is ready to tackle the gnarliest trails all around the world. Book it for an unforgettable adventure.", price: 300, image_url: "items/mtb.jpg", address: "Frechen, Cologne, Germany"},
  { user: amanda, name: "Stand-up paddle set", description: "Stand up paddling board, SUP board as an inflatable complete set, stand up paddle board with double PVC layering, optimal from 60 kg max 130 kg - 330 x 78 x 15 cm", price: 25, image_url: "items/paddle-board.jpg", address: "Ehrenfeld, Cologne" },
  ...
  { user: alex, name: "Volleyball Ball", description: "White, spherical, can handle being thrown and loves the sand. Your ideal companion fo this summer season.", price: 20, image_url: "items/volleyball.jpg", address: "Mediapark, Cologne, Germany" },
